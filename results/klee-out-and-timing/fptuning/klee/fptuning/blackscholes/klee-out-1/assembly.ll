...
@.str21 = private unnamed_addr constant [16 x i8] c"invsqrt2xPI_err\00", align 1
@.str22 = private unnamed_addr constant [10 x i8] c"datas_err\00", align 1
@.str23 = private unnamed_addr constant [15 x i8] c"datastrike_err\00", align 1
@.str24 = private unnamed_addr constant [10 x i8] c"datar_err\00", align 1
@.str25 = private unnamed_addr constant [13 x i8] c"datadivq_err\00", align 1
@.str26 = private unnamed_addr constant [10 x i8] c"datav_err\00", align 1
@.str27 = private unnamed_addr constant [10 x i8] c"datat_err\00", align 1
@.str28 = private unnamed_addr constant [13 x i8] c"datadivs_err\00", align 1
@.str29 = private unnamed_addr constant [17 x i8] c"dataDGrefval_err\00", align 1
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  call void @klee_track_error(i8* bitcast (i32* @inv_sqrt_2xPI to i8*), i8* getelementptr inbounds ([16 x i8]* @.str21, i32 0, i32 0)), !dbg !267
  call void @klee_track_error(i8* bitcast (i32* @data_s to i8*), i8* getelementptr inbounds ([10 x i8]* @.str22, i32 0, i32 0)), !dbg !268
  call void @klee_track_error(i8* bitcast (i32* @data_strike to i8*), i8* getelementptr inbounds ([15 x i8]* @.str23, i32 0, i32 0)), !dbg !269
  call void @klee_track_error(i8* bitcast (i32* @data_r to i8*), i8* getelementptr inbounds ([10 x i8]* @.str24, i32 0, i32 0)), !dbg !270
  call void @klee_track_error(i8* bitcast (i32* @data_divq to i8*), i8* getelementptr inbounds ([13 x i8]* @.str25, i32 0, i32 0)), !dbg !271
  call void @klee_track_error(i8* bitcast (i32* @data_v to i8*), i8* getelementptr inbounds ([10 x i8]* @.str26, i32 0, i32 0)), !dbg !272
  call void @klee_track_error(i8* bitcast (i32* @data_t to i8*), i8* getelementptr inbounds ([10 x i8]* @.str27, i32 0, i32 0)), !dbg !273
  call void @klee_track_error(i8* bitcast (i32* @data_divs to i8*), i8* getelementptr inbounds ([13 x i8]* @.str28, i32 0, i32 0)), !dbg !274
  call void @klee_track_error(i8* bitcast (i32* @data_DGrefval to i8*), i8* getelementptr inbounds ([17 x i8]* @.str29, i32 0, i32 0)), !dbg !275
...
entry:
  ...
  %0 = bitcast i32* %x to i8*, !dbg !300
  call void @klee_make_symbolic(i8* %0, i64 4, i8* %name) #8, !dbg !300
  %1 = load i32* %x, align 4, !dbg !301, !tbaa !302
  ret i32 %1, !dbg !301
}
...
entry:
  %cmp = icmp ult i64 %shift, %bitWidth, !dbg !306
  br i1 %cmp, label %if.end, label %if.then, !dbg !306
...
entry:
  %x = alloca i32, align 4
  %cmp = icmp slt i32 %start, %end, !dbg !311
  br i1 %cmp, label %if.end, label %if.then, !dbg !311
...
if.end:                                           ; preds = %entry
  %add = add nsw i32 %start, 1, !dbg !314
  %cmp1 = icmp eq i32 %add, %end, !dbg !314
  br i1 %cmp1, label %return, label %if.else, !dbg !314

if.else:                                          ; preds = %if.end
  %0 = bitcast i32* %x to i8*, !dbg !316
  call void @klee_make_symbolic(i8* %0, i64 4, i8* %name) #8, !dbg !316
  %cmp3 = icmp eq i32 %start, 0, !dbg !318
  %1 = load i32* %x, align 4, !dbg !320, !tbaa !302
  br i1 %cmp3, label %if.then4, label %if.else7, !dbg !318

if.then4:                                         ; preds = %if.else
  %cmp5 = icmp ult i32 %1, %end, !dbg !320
  %conv6 = zext i1 %cmp5 to i64, !dbg !320
  call void @klee_assume(i64 %conv6) #8, !dbg !320
  br label %if.end14, !dbg !322

if.else7:                                         ; preds = %if.else
  %cmp8 = icmp sge i32 %1, %start, !dbg !323
  %conv10 = zext i1 %cmp8 to i64, !dbg !323
  call void @klee_assume(i64 %conv10) #8, !dbg !323
  %2 = load i32* %x, align 4, !dbg !325, !tbaa !302
  %cmp11 = icmp slt i32 %2, %end, !dbg !325
  %conv13 = zext i1 %cmp11 to i64, !dbg !325
  call void @klee_assume(i64 %conv13) #8, !dbg !325
  br label %if.end14

if.end14:                                         ; preds = %if.else7, %if.then4
  %3 = load i32* %x, align 4, !dbg !326, !tbaa !302
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %2 = getelementptr i8* %srcaddr, i64 %next.gep.sum282, !dbg !329
  %3 = bitcast i8* %2 to <16 x i8>*, !dbg !329
  %wide.load203 = load <16 x i8>* %3, align 1, !dbg !329
  %4 = bitcast i8* %next.gep106 to <16 x i8>*, !dbg !329
  store <16 x i8> %wide.load, <16 x i8>* %4, align 1, !dbg !329
  %5 = getelementptr i8* %destaddr, i64 %next.gep.sum282, !dbg !329
  %6 = bitcast i8* %5 to <16 x i8>*, !dbg !329
  store <16 x i8> %wide.load203, <16 x i8>* %6, align 1, !dbg !329
...
while.body:                                       ; preds = %while.body, %middle.block
  ...
  %8 = load i8* %src.06, align 1, !dbg !329, !tbaa !333
  %incdec.ptr1 = getelementptr inbounds i8* %dest.05, i64 1, !dbg !329
  store i8 %8, i8* %dest.05, align 1, !dbg !329, !tbaa !333
  %cmp = icmp eq i64 %dec, 0, !dbg !328
  br i1 %cmp, label %while.end, label %while.body, !dbg !328, !llvm.loop !334
...
entry:
  %cmp = icmp eq i8* %src, %dst, !dbg !336
  br i1 %cmp, label %return, label %if.end, !dbg !336

if.end:                                           ; preds = %entry
  %cmp1 = icmp ugt i8* %src, %dst, !dbg !338
  br i1 %cmp1, label %while.cond.preheader, label %if.else, !dbg !338

while.cond.preheader:                             ; preds = %if.end
  %tobool27 = icmp eq i64 %count, 0, !dbg !340
  br i1 %tobool27, label %return, label %while.body.preheader, !dbg !340
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %next.gep.sum610 = or i64 %index, 16, !dbg !340
  %2 = getelementptr i8* %src, i64 %next.gep.sum610, !dbg !340
  %3 = bitcast i8* %2 to <16 x i8>*, !dbg !340
  %wide.load233 = load <16 x i8>* %3, align 1, !dbg !340
  %4 = bitcast i8* %next.gep136 to <16 x i8>*, !dbg !340
  store <16 x i8> %wide.load, <16 x i8>* %4, align 1, !dbg !340
  %5 = getelementptr i8* %dst, i64 %next.gep.sum610, !dbg !340
  %6 = bitcast i8* %5 to <16 x i8>*, !dbg !340
  store <16 x i8> %wide.load233, <16 x i8>* %6, align 1, !dbg !340
  %index.next = add i64 %index, 32
  %7 = icmp eq i64 %index.next, %n.vec
  br i1 %7, label %middle.block, label %vector.body, !llvm.loop !342
...
while.body:                                       ; preds = %while.body, %middle.block
  ...
  %dec = add i64 %count.addr.028, -1, !dbg !340
  %incdec.ptr = getelementptr inbounds i8* %b.030, i64 1, !dbg !340
  %8 = load i8* %b.030, align 1, !dbg !340, !tbaa !333
  %incdec.ptr3 = getelementptr inbounds i8* %a.029, i64 1, !dbg !340
  store i8 %8, i8* %a.029, align 1, !dbg !340, !tbaa !333
  %tobool = icmp eq i64 %dec, 0, !dbg !340
  br i1 %tobool, label %return, label %while.body, !dbg !340, !llvm.loop !343

if.else:                                          ; preds = %if.end
  %sub = add i64 %count, -1, !dbg !344
  %tobool832 = icmp eq i64 %count, 0, !dbg !346
  br i1 %tobool832, label %return, label %while.body9.lr.ph, !dbg !346

while.body9.lr.ph:                                ; preds = %if.else
  %add.ptr5 = getelementptr inbounds i8* %src, i64 %sub, !dbg !347
  %add.ptr = getelementptr inbounds i8* %dst, i64 %sub, !dbg !344
...
vector.body235:                                   ; preds = %vector.body235, %vector.memcheck250
  ...
  %next.gep262.sum = add i64 %add.ptr5.sum465, -15, !dbg !346
  %9 = getelementptr i8* %src, i64 %next.gep262.sum, !dbg !346
  %10 = bitcast i8* %9 to <16 x i8>*, !dbg !346
  %wide.load460 = load <16 x i8>* %10, align 1, !dbg !346
  %reverse = shufflevector <16 x i8> %wide.load460, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !346
  %.sum = add i64 %add.ptr5.sum465, -31, !dbg !346
  %11 = getelementptr i8* %src, i64 %.sum, !dbg !346
  %12 = bitcast i8* %11 to <16 x i8>*, !dbg !346
  %wide.load461 = load <16 x i8>* %12, align 1, !dbg !346
  %reverse462 = shufflevector <16 x i8> %wide.load461, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !346
  %reverse463 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !346
  %13 = getelementptr i8* %dst, i64 %next.gep262.sum, !dbg !346
  %14 = bitcast i8* %13 to <16 x i8>*, !dbg !346
  store <16 x i8> %reverse463, <16 x i8>* %14, align 1, !dbg !346
  %reverse464 = shufflevector <16 x i8> %reverse462, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !346
  %15 = getelementptr i8* %dst, i64 %.sum, !dbg !346
  %16 = bitcast i8* %15 to <16 x i8>*, !dbg !346
  store <16 x i8> %reverse464, <16 x i8>* %16, align 1, !dbg !346
  %index.next260 = add i64 %index238, 32
  %17 = icmp eq i64 %index.next260, %n.vec241
  br i1 %17, label %middle.block236, label %vector.body235, !llvm.loop !348
...
while.body9:                                      ; preds = %while.body9, %middle.block236
  ...
  %dec7 = add i64 %count.addr.133, -1, !dbg !346
  %incdec.ptr10 = getelementptr inbounds i8* %b.135, i64 -1, !dbg !346
  %18 = load i8* %b.135, align 1, !dbg !346, !tbaa !333
  %incdec.ptr11 = getelementptr inbounds i8* %a.134, i64 -1, !dbg !346
  store i8 %18, i8* %a.134, align 1, !dbg !346, !tbaa !333
  %tobool8 = icmp eq i64 %dec7, 0, !dbg !346
  br i1 %tobool8, label %return, label %while.body9, !dbg !346, !llvm.loop !349
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %next.gep.sum283 = or i64 %index, 16, !dbg !352
  %2 = getelementptr i8* %srcaddr, i64 %next.gep.sum283, !dbg !352
  %3 = bitcast i8* %2 to <16 x i8>*, !dbg !352
  %wide.load204 = load <16 x i8>* %3, align 1, !dbg !352
  %4 = bitcast i8* %next.gep107 to <16 x i8>*, !dbg !352
  store <16 x i8> %wide.load, <16 x i8>* %4, align 1, !dbg !352
  %5 = getelementptr i8* %destaddr, i64 %next.gep.sum283, !dbg !352
  %6 = bitcast i8* %5 to <16 x i8>*, !dbg !352
  store <16 x i8> %wide.load204, <16 x i8>* %6, align 1, !dbg !352
  %index.next = add i64 %index, 32
  %7 = icmp eq i64 %index.next, %n.vec
...
while.body:                                       ; preds = %while.body, %middle.block
  ...
  %8 = load i8* %src.06, align 1, !dbg !352, !tbaa !333
  %incdec.ptr1 = getelementptr inbounds i8* %dest.05, i64 1, !dbg !352
  store i8 %8, i8* %dest.05, align 1, !dbg !352, !tbaa !333
  %cmp = icmp eq i64 %dec, 0, !dbg !351
  br i1 %cmp, label %while.cond.while.end_crit_edge, label %while.body, !dbg !351, !llvm.loop !354

while.cond.while.end_crit_edge:                   ; preds = %while.body, %middle.block
  %scevgep = getelementptr i8* %destaddr, i64 %len
  br label %while.end, !dbg !351
...
entry:
  %cmp2 = icmp eq i64 %count, 0, !dbg !356
  br i1 %cmp2, label %while.end, label %while.body.lr.ph, !dbg !356

while.body.lr.ph:                                 ; preds = %entry
  %conv = trunc i32 %s to i8, !dbg !357
  br label %while.body, !dbg !356

while.body:                                       ; preds = %while.body, %while.body.lr.ph
  %a.04 = phi i8* [ %dst, %while.body.lr.ph ], [ %incdec.ptr, %while.body ]
  %count.addr.03 = phi i64 [ %count, %while.body.lr.ph ], [ %dec, %while.body ]
  %dec = add i64 %count.addr.03, -1, !dbg !356
  %incdec.ptr = getelementptr inbounds i8* %a.04, i64 1, !dbg !357
  store volatile i8 %conv, i8* %a.04, align 1, !dbg !357, !tbaa !333
  %cmp = icmp eq i64 %dec, 0, !dbg !356
  br i1 %cmp, label %while.end, label %while.body, !dbg !356
...
!45 = metadata !{metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_div_zero_check.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
...
!48 = metadata !{metadata !"klee_div_zero_check.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
!49 = metadata !{i32 786473, metadata !48}        ; [ DW_TAG_file_type ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_div_zero_check.c]
...
!56 = metadata !{metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_int.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
...
!59 = metadata !{metadata !"klee_int.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
!60 = metadata !{i32 786473, metadata !59}        ; [ DW_TAG_file_type ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_int.c]
...
!69 = metadata !{metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_overshift_check.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
...
!72 = metadata !{metadata !"klee_overshift_check.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
!73 = metadata !{i32 786473, metadata !72}        ; [ DW_TAG_file_type ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_overshift_check.c]
...
!81 = metadata !{metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_range.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
...
!84 = metadata !{metadata !"klee_range.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
!85 = metadata !{i32 786473, metadata !84}        ; [ DW_TAG_file_type ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_range.c]
...
!94 = metadata !{metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic/memcpy.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
...
!97 = metadata !{metadata !"memcpy.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
!98 = metadata !{i32 786473, metadata !97}        ; [ DW_TAG_file_type ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/memcpy.c]
...
!112 = metadata !{metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic/memmove.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
...
!115 = metadata !{metadata !"memmove.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
!116 = metadata !{i32 786473, metadata !115}      ; [ DW_TAG_file_type ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/memmove.c]
...
!127 = metadata !{metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic/mempcpy.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
...
!130 = metadata !{metadata !"mempcpy.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
!131 = metadata !{i32 786473, metadata !130}      ; [ DW_TAG_file_type ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/mempcpy.c]
...
!142 = metadata !{metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic/memset.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
...
!145 = metadata !{metadata !"memset.c", metadata !"/home/himeshi/approx/klee/klee/runtime/Intrinsic"}
!146 = metadata !{i32 786473, metadata !145}      ; [ DW_TAG_file_type ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/memset.c]
...
!297 = metadata !{i32 786443, metadata !48, metadata !47, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_div_zero_check.c]
...
!307 = metadata !{i32 786443, metadata !72, metadata !71, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_overshift_check.c]
!308 = metadata !{i32 27, i32 0, metadata !309, null}
!309 = metadata !{i32 786443, metadata !72, metadata !307, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_overshift_check.c]
!310 = metadata !{i32 29, i32 0, metadata !71, null}
!311 = metadata !{i32 16, i32 0, metadata !312, null}
!312 = metadata !{i32 786443, metadata !84, metadata !83, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_range.c]
!313 = metadata !{i32 17, i32 0, metadata !312, null}
!314 = metadata !{i32 19, i32 0, metadata !315, null}
!315 = metadata !{i32 786443, metadata !84, metadata !83, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_range.c]
!316 = metadata !{i32 22, i32 0, metadata !317, null}
!317 = metadata !{i32 786443, metadata !84, metadata !315, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_range.c]
!318 = metadata !{i32 25, i32 0, metadata !319, null}
!319 = metadata !{i32 786443, metadata !84, metadata !317, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_range.c]
!320 = metadata !{i32 26, i32 0, metadata !321, null}
!321 = metadata !{i32 786443, metadata !84, metadata !319, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_range.c]
!322 = metadata !{i32 27, i32 0, metadata !321, null}
!323 = metadata !{i32 28, i32 0, metadata !324, null}
!324 = metadata !{i32 786443, metadata !84, metadata !319, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/klee_range.c]
...
!337 = metadata !{i32 786443, metadata !115, metadata !114, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/memmove.c]
!338 = metadata !{i32 19, i32 0, metadata !339, null}
!339 = metadata !{i32 786443, metadata !115, metadata !114, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/memmove.c]
!340 = metadata !{i32 20, i32 0, metadata !341, null}
!341 = metadata !{i32 786443, metadata !115, metadata !339, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/memmove.c]
...
!345 = metadata !{i32 786443, metadata !115, metadata !339, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/himeshi/approx/klee/klee/runtime/Intrinsic/memmove.c]
