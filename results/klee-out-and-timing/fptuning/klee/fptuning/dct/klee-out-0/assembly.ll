...
define void @klee_div_zero_check(i64 %z) #3 {
  %1 = icmp eq i64 %z, 0, !dbg !302
  br i1 %1, label %2, label %3, !dbg !302
...
define i32 @klee_int(i8* %name) #3 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !306
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #7, !dbg !306
  %2 = load i32* %x, align 4, !dbg !307, !tbaa !308
  ret i32 %2, !dbg !307
}

; Function Attrs: nounwind uwtable
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #3 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !312
  br i1 %1, label %3, label %2, !dbg !312
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #3 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !317
  br i1 %1, label %3, label %2, !dbg !317
...
; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !320
  %5 = icmp eq i32 %4, %end, !dbg !320
  br i1 %5, label %21, label %6, !dbg !320

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !322
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #7, !dbg !322
  %8 = icmp eq i32 %start, 0, !dbg !324
  %9 = load i32* %x, align 4, !dbg !326, !tbaa !308
  br i1 %8, label %10, label %13, !dbg !324

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !326
  %12 = zext i1 %11 to i64, !dbg !326
  call void @klee_assume(i64 %12) #7, !dbg !326
  br label %19, !dbg !328

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !329
  %15 = zext i1 %14 to i64, !dbg !329
  call void @klee_assume(i64 %15) #7, !dbg !329
  %16 = load i32* %x, align 4, !dbg !331, !tbaa !308
  %17 = icmp slt i32 %16, %end, !dbg !331
  %18 = zext i1 %17 to i64, !dbg !331
  call void @klee_assume(i64 %18) #7, !dbg !331
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !332, !tbaa !308
  br label %21, !dbg !332
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #3 {
  %1 = icmp eq i64 %len, 0, !dbg !334
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !334
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !335
  %wide.load = load <16 x i8>* %3, align 1, !dbg !335
  %next.gep.sum279 = or i64 %index, 16, !dbg !335
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !335
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !335
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !335
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !335
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !335
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum279, !dbg !335
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !335
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !335
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !336
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !334
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !335
  %12 = load i8* %src.03, align 1, !dbg !335, !tbaa !339
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !335
  store i8 %12, i8* %dest.02, align 1, !dbg !335, !tbaa !339
  %14 = icmp eq i64 %10, 0, !dbg !334
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !334, !llvm.loop !340
...
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #3 {
  %1 = icmp eq i8* %src, %dst, !dbg !342
  br i1 %1, label %.loopexit, label %2, !dbg !342

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !344
  br i1 %3, label %.preheader, label %18, !dbg !344

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !346
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !346
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !346
  %wide.load = load <16 x i8>* %6, align 1, !dbg !346
  %next.gep.sum586 = or i64 %index, 16, !dbg !346
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !346
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !346
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !346
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !346
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !346
  %10 = getelementptr i8* %dst, i64 %next.gep.sum586, !dbg !346
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !346
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !346
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !348
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !346
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !346
  %15 = load i8* %b.04, align 1, !dbg !346, !tbaa !339
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !346
  store i8 %15, i8* %a.03, align 1, !dbg !346, !tbaa !339
  %17 = icmp eq i64 %13, 0, !dbg !346
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !346, !llvm.loop !349

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !350
  %20 = icmp eq i64 %count, 0, !dbg !352
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !352

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !353
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !350
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !352
  %23 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !352
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !352
  %wide.load434 = load <16 x i8>* %24, align 1, !dbg !352
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !352
  %.sum505 = add i64 %.sum440, -31, !dbg !352
  %25 = getelementptr i8* %src, i64 %.sum505, !dbg !352
  %26 = bitcast i8* %25 to <16 x i8>*, !dbg !352
  %wide.load435 = load <16 x i8>* %26, align 1, !dbg !352
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !352
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !352
  %27 = getelementptr i8* %dst, i64 %next.gep236.sum, !dbg !352
  %28 = bitcast i8* %27 to <16 x i8>*, !dbg !352
  store <16 x i8> %reverse437, <16 x i8>* %28, align 1, !dbg !352
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !352
  %29 = getelementptr i8* %dst, i64 %.sum505, !dbg !352
  %30 = bitcast i8* %29 to <16 x i8>*, !dbg !352
  store <16 x i8> %reverse438, <16 x i8>* %30, align 1, !dbg !352
  %index.next234 = add i64 %index212, 32
  %31 = icmp eq i64 %index.next234, %n.vec215
  br i1 %31, label %middle.block210, label %vector.body209, !llvm.loop !354
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %32 = add i64 %.16, -1, !dbg !352
  %33 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !352
  %34 = load i8* %b.18, align 1, !dbg !352, !tbaa !339
  %35 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !352
  store i8 %34, i8* %a.17, align 1, !dbg !352, !tbaa !339
  %36 = icmp eq i64 %32, 0, !dbg !352
  br i1 %36, label %.loopexit, label %scalar.ph211, !dbg !352, !llvm.loop !355
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #3 {
  %1 = icmp eq i64 %len, 0, !dbg !357
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !357
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !358
  %wide.load = load <16 x i8>* %3, align 1, !dbg !358
  %next.gep.sum280 = or i64 %index, 16, !dbg !358
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !358
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !358
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !358
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !358
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !358
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum280, !dbg !358
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !358
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !358
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !359
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !357
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !358
  %12 = load i8* %src.03, align 1, !dbg !358, !tbaa !339
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !358
  store i8 %12, i8* %dest.02, align 1, !dbg !358, !tbaa !339
  %14 = icmp eq i64 %10, 0, !dbg !357
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !357, !llvm.loop !360
...
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #3 {
  %1 = icmp eq i64 %count, 0, !dbg !362
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !362

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !363
  br label %3, !dbg !362

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !362
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !363
  store volatile i8 %2, i8* %a.02, align 1, !dbg !363, !tbaa !339
  %6 = icmp eq i64 %4, 0, !dbg !362
  br i1 %6, label %._crit_edge, label %3, !dbg !362
...
!51 = metadata !{metadata !"/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_overshift_check.c", metadata !"/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic"}
...
!54 = metadata !{metadata !"klee_overshift_check.c", metadata !"/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic"}
!55 = metadata !{i32 786473, metadata !54}        ; [ DW_TAG_file_type ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_overshift_check.c]
...
!63 = metadata !{metadata !"/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c", metadata !"/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic"}
...
!66 = metadata !{metadata !"klee_range.c", metadata !"/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic"}
!67 = metadata !{i32 786473, metadata !66}        ; [ DW_TAG_file_type ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
...
!76 = metadata !{metadata !"/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/memcpy.c", metadata !"/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic"}
...
!79 = metadata !{metadata !"memcpy.c", metadata !"/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic"}
!80 = metadata !{i32 786473, metadata !79}        ; [ DW_TAG_file_type ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/memcpy.c]
...
!303 = metadata !{i32 786443, metadata !30, metadata !29, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_div_zero_check.c]
...
!313 = metadata !{i32 786443, metadata !54, metadata !53, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_overshift_check.c]
!314 = metadata !{i32 27, i32 0, metadata !315, null}
!315 = metadata !{i32 786443, metadata !54, metadata !313, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_overshift_check.c]
!316 = metadata !{i32 29, i32 0, metadata !53, null}
!317 = metadata !{i32 16, i32 0, metadata !318, null}
!318 = metadata !{i32 786443, metadata !66, metadata !65, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
!319 = metadata !{i32 17, i32 0, metadata !318, null}
!320 = metadata !{i32 19, i32 0, metadata !321, null}
!321 = metadata !{i32 786443, metadata !66, metadata !65, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
!322 = metadata !{i32 22, i32 0, metadata !323, null}
!323 = metadata !{i32 786443, metadata !66, metadata !321, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
!324 = metadata !{i32 25, i32 0, metadata !325, null}
!325 = metadata !{i32 786443, metadata !66, metadata !323, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
!326 = metadata !{i32 26, i32 0, metadata !327, null}
!327 = metadata !{i32 786443, metadata !66, metadata !325, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
!328 = metadata !{i32 27, i32 0, metadata !327, null}
!329 = metadata !{i32 28, i32 0, metadata !330, null}
!330 = metadata !{i32 786443, metadata !66, metadata !325, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
...
!343 = metadata !{i32 786443, metadata !98, metadata !97, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/memmove.c]
!344 = metadata !{i32 19, i32 0, metadata !345, null}
!345 = metadata !{i32 786443, metadata !98, metadata !97, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/memmove.c]
!346 = metadata !{i32 20, i32 0, metadata !347, null}
!347 = metadata !{i32 786443, metadata !98, metadata !345, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/memmove.c]
...
!351 = metadata !{i32 786443, metadata !98, metadata !345, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/memmove.c]
