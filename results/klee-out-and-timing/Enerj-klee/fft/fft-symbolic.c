 ...
 * fft-symbolic.c
 *
 * Compile with: /home/himeshi/approx/klee/llvm-build/Release+Asserts/bin/clang -I /home/himeshi/approx/klee/klee/include -emit-llvm -c -g fft-symbolic.c
 * Run with: /home/himeshi/approx/klee/klee/Release+Asserts/bin/klee --write-kqueries --precision --math-calls --scaling fft-symbolic.bc
 *
