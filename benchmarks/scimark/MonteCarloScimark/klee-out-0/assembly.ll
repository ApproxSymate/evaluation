...
@.str2 = private unnamed_addr constant [8 x i8] c"x_error\00", align 1
@.str3 = private unnamed_addr constant [8 x i8] c"y_error\00", align 1
@.str4 = private unnamed_addr constant [12 x i8] c"under_curve\00", align 1
@.str5 = private unnamed_addr constant [7 x i8] c"result\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 1, i32* %Num_samples, align 4, !dbg !129
  ...
  %3 = bitcast i32* %y to i8*, !dbg !131
  call void @klee_make_symbolic(i8* %3, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0)), !dbg !131
  %4 = bitcast i32* %x to i8*, !dbg !132
  call void @klee_track_error(i8* %4, i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0)), !dbg !132
  %5 = bitcast i32* %y to i8*, !dbg !133
  call void @klee_track_error(i8* %5, i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0)), !dbg !133
  store i32 0, i32* %count, align 4, !dbg !134
  br label %6, !dbg !134

; <label>:6                                       ; preds = %22, %0
  %7 = load i32* %count, align 4, !dbg !134
  %8 = load i32* %Num_samples, align 4, !dbg !134
  %9 = icmp slt i32 %7, %8, !dbg !134
  br i1 %9, label %10, label %25, !dbg !134

; <label>:10                                      ; preds = %6
  %11 = load i32* %x, align 4, !dbg !136
  %12 = load i32* %x, align 4, !dbg !136
  %13 = mul nsw i32 %11, %12, !dbg !136
  %14 = load i32* %y, align 4, !dbg !136
  %15 = load i32* %y, align 4, !dbg !136
  %16 = mul nsw i32 %14, %15, !dbg !136
  %17 = add nsw i32 %13, %16, !dbg !136
  %18 = icmp sle i32 %17, 1, !dbg !136
  br i1 %18, label %19, label %22, !dbg !136

; <label>:19                                      ; preds = %10
  %20 = load i32* %under_curve, align 4, !dbg !139
  %21 = add nsw i32 %20, 1, !dbg !139
  store i32 %21, i32* %under_curve, align 4, !dbg !139
  br label %22, !dbg !139

; <label>:22                                      ; preds = %10, %19
  %23 = load i32* %count, align 4, !dbg !134
  %24 = add nsw i32 %23, 1, !dbg !134
  store i32 %24, i32* %count, align 4, !dbg !134
  br label %6, !dbg !134

; <label>:25                                      ; preds = %6
  %26 = load i32* %under_curve, align 4, !dbg !140
  %27 = load i32* %Num_samples, align 4, !dbg !140
  %int_cast_to_i64 = zext i32 %27 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !140
  %28 = sdiv i32 %26, %27, !dbg !140
  %29 = mul nsw i32 %28, 4, !dbg !140
  store i32 %29, i32* %result, align 4, !dbg !140
  %30 = load i32* %under_curve, align 4, !dbg !141
  %31 = sext i32 %30 to i64, !dbg !141
  call void @klee_bound_error(i64 %31, i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), double 1.000000e+00), !dbg !141
  %32 = load i32* %x, align 4, !dbg !142
  %33 = sext i32 %32 to i64, !dbg !142
  call void @klee_bound_error(i64 %33, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0), double 1.000000e+00), !dbg !142
  %34 = load i32* %y, align 4, !dbg !143
  %35 = sext i32 %34 to i64, !dbg !143
  call void @klee_bound_error(i64 %35, i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0), double 1.000000e+00), !dbg !143
  %36 = load i32* %result, align 4, !dbg !144
  %37 = sext i32 %36 to i64, !dbg !144
  call void @klee_bound_error(i64 %37, i8* getelementptr inbounds ([7 x i8]* @.str5, i32 0, i32 0), double 1.000000e+00), !dbg !144
  ret i32 0, !dbg !145
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str6, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str28, i64 0, i64 0)) #6, !dbg !148
  unreachable, !dbg !148
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str39, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #6, !dbg !158
  unreachable, !dbg !158
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str610, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str1711, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str2812, i64 0, i64 0)) #6, !dbg !163
  unreachable, !dbg !163
...
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 51, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 51} ; [ DW_TAG_subprogram ] [
...
!128 = metadata !{i32 53, i32 0, metadata !4, null}
!129 = metadata !{i32 59, i32 0, metadata !4, null}
!130 = metadata !{i32 61, i32 0, metadata !4, null}
!131 = metadata !{i32 62, i32 0, metadata !4, null}
!132 = metadata !{i32 64, i32 0, metadata !4, null}
!133 = metadata !{i32 65, i32 0, metadata !4, null}
!134 = metadata !{i32 67, i32 0, metadata !135, null}
!135 = metadata !{i32 786443, metadata !1, metadata !4, i32 67, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/workspace/MonteCarloScimark/montecarlo.c]
!136 = metadata !{i32 69, i32 0, metadata !137, null}
!137 = metadata !{i32 786443, metadata !1, metadata !138, i32 69, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/workspace/MonteCarloScimark/montecarlo.c]
!138 = metadata !{i32 786443, metadata !1, metadata !135, i32 67, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/workspace/MonteCarloScimark/montecarlo.c]
!139 = metadata !{i32 70, i32 0, metadata !137, null}
!140 = metadata !{i32 74, i32 0, metadata !4, null}
!141 = metadata !{i32 76, i32 0, metadata !4, null}
!142 = metadata !{i32 77, i32 0, metadata !4, null}
!143 = metadata !{i32 78, i32 0, metadata !4, null}
!144 = metadata !{i32 79, i32 0, metadata !4, null}
!145 = metadata !{i32 81, i32 0, metadata !4, null}
!146 = metadata !{i32 13, i32 0, metadata !147, null}
!147 = metadata !{i32 786443, metadata !13, metadata !12, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_div_zero_check.c]
...
!157 = metadata !{i32 786443, metadata !38, metadata !37, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_overshift_check.c]
!158 = metadata !{i32 27, i32 0, metadata !159, null}
!159 = metadata !{i32 786443, metadata !38, metadata !157, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_overshift_check.c]
!160 = metadata !{i32 29, i32 0, metadata !37, null}
!161 = metadata !{i32 16, i32 0, metadata !162, null}
!162 = metadata !{i32 786443, metadata !50, metadata !49, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
!163 = metadata !{i32 17, i32 0, metadata !162, null}
!164 = metadata !{i32 19, i32 0, metadata !165, null}
!165 = metadata !{i32 786443, metadata !50, metadata !49, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
!166 = metadata !{i32 22, i32 0, metadata !167, null}
!167 = metadata !{i32 786443, metadata !50, metadata !165, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
!168 = metadata !{i32 25, i32 0, metadata !169, null}
!169 = metadata !{i32 786443, metadata !50, metadata !167, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
!170 = metadata !{i32 26, i32 0, metadata !171, null}
!171 = metadata !{i32 786443, metadata !50, metadata !169, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
!172 = metadata !{i32 27, i32 0, metadata !171, null}
!173 = metadata !{i32 28, i32 0, metadata !174, null}
!174 = metadata !{i32 786443, metadata !50, metadata !169, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/klee_range.c]
...
!187 = metadata !{i32 786443, metadata !83, metadata !82, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/memmove.c]
!188 = metadata !{i32 19, i32 0, metadata !189, null}
!189 = metadata !{i32 786443, metadata !83, metadata !82, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/memmove.c]
!190 = metadata !{i32 20, i32 0, metadata !191, null}
!191 = metadata !{i32 786443, metadata !83, metadata !189, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/memmove.c]
...
!195 = metadata !{i32 786443, metadata !83, metadata !189, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/himeshi/Projects/Approx/klee/klee/runtime/Intrinsic/memmove.c]
