...
; <label>:121                                     ; preds = %116
  ...
  %126 = load [2 x i32]** %4, align 8, !dbg !185
  %127 = getelementptr inbounds [2 x i32]* %126, i64 %125, !dbg !185
  %128 = getelementptr inbounds [2 x i32]* %127, i32 0, i64 %123, !dbg !185
...
; <label>:137                                     ; preds = %133
  ...
  %143 = load [2 x i32]** %4, align 8, !dbg !189
  %144 = getelementptr inbounds [2 x i32]* %143, i64 %142, !dbg !189
  %145 = getelementptr inbounds [2 x i32]* %144, i32 0, i64 %140, !dbg !189
...
; <label>:162                                     ; preds = %158
  ...
  %165 = load [2 x i32]** %4, align 8, !dbg !195
  %166 = getelementptr inbounds [2 x i32]* %165, i64 %164, !dbg !195
  %167 = getelementptr inbounds [2 x i32]* %166, i32 0, i32 0, !dbg !195
  store i32* %167, i32** %Aii, align 8, !dbg !195
  %168 = load i32* %j, align 4, !dbg !197
  %169 = sext i32 %168 to i64, !dbg !197
  %170 = load [2 x i32]** %4, align 8, !dbg !197
  %171 = getelementptr inbounds [2 x i32]* %170, i64 %169, !dbg !197
  %172 = getelementptr inbounds [2 x i32]* %171, i32 0, i32 0, !dbg !197
...
; <label>:208                                     ; preds = %12
  %209 = load [2 x i32]** %4, align 8, !dbg !203
  %210 = getelementptr inbounds [2 x i32]* %209, i64 0, !dbg !203
  %211 = getelementptr inbounds [2 x i32]* %210, i32 0, i64 0, !dbg !203
