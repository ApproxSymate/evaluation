 ...
 * fft-symbolic.c
 *
 * Compile with: clang -I klee/include -emit-llvm -c -g fft-symbolic.c
 * Run with: klee --write-kqueries --precision --math-calls --scaling fft-symbolic.bc
 *
...
int main() {
	...
	klee_make_symbolic(x, sizeof(int) * 32, "__arr32__x");
